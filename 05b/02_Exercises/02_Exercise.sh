...
General usage is: ./02_Exercise.sh <EXTERNAL-IP> <PORT>
Example: ./02_Exercise.sh 192.168.49.2 32045

Run it with your Minikube IP & NodePort:
./02_Exercise.sh $(minikube ip) 32045
...
# 5. list Filesystem (first 10 lines)
#??
#??
